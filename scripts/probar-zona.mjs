...
const casos = [
  ...
  ['Istmina', 5.1606, -76.6844, true], ['Chaparral', 3.7236, -75.4847, true],
  ['Sur de Chaparral', 3.6, -75.5, true], ['Rioblanco', 3.53, -75.645, true], ['San José del Palmar', 4.8964, -76.2342, true],
